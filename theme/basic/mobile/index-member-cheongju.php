    ...
    <div class="page-content header-clear-small">
        ...
        <div class="card card-style preload-img" data-src="images/pictures/18.jpg" data-card-height="130">
            <div class="card-center ml-3">
                ...
                <p class="color-white mt-n1 mb-0">회원 | 청주시 (<?= $_section[$_REQUEST["category"]] ?>)</p>
            </div>
        ...
        <div class="search-page">
            ...
            <div class="search-results card card-style shadow-l">
                <div class="content">
                    ...
                    where mb_6 = 'cbvet' AND mb_7 = '{$_REQUEST["category"]}'";
                    // $sql .= " order by mb_no";
                ...
                <div class="row mb-0">
                    ...
                    <div class="col-9 pl-4">
                        <div class="d-flex">
                            ...
                            <div class="ml-auto"><p>청주시 <?= $_section[$_REQUEST["category"]] ?></p></div>
                        </div>
                        <div class="d-flex">
