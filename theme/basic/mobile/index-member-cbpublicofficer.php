        ...
        <div class="search-page">
            ...
            <div class="search-results card card-style shadow-l">
                <div class="content">
                    ...
                    where mb_6 = 'cbpublicofficer' AND mb_7 = '{$_REQUEST["category"]}'";
                    // $sql .= " order by mb_no";
    ...
    <div id="menu-transaction-<?php echo $row["mb_id"] ?>" class="menu menu-box-bottom menu-box-detached rounded-m" data-menu-height="480" style="height: 480px; display: block;">
        ...
        <div class="content">
            ...
            <div class="row mb-0">
                ...
                <div class="col-6"><h4 class="font-14 text-right mt-1 color-green1-dark"><a href="tel:<?=$row["mb_tel"] ?>"><?php echo $row["mb_hp"] ?></a></h4></div>
